...
public class XunFeiManager : MonoBehaviour
{
    ...
    private const string APPID = "2dd95d37";
    /// <summary>改成你自己的APISecret!!!!!!</summary>
    private const string APISecret = "ZGY1OThjNjkwYjM2YjI0MDM3YmQ5ZTQ3";
    /// <summary>改成你自己的APIKey!!!!!!</summary>
    private const string APIKey = "a19d98ccedeb2f6a6177ec0c5c885d39";
